...
import com.example.bilgin.BarcodeActivity;
import com.example.bilgin.com.models.Employee;

/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement thece
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        payButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //myIntent.putExtra("employee", mListener.getEmployee());
                startActivity(myIntent);
            }
        });
        listView = v.findViewById(R.id.listview);
        ArrayAdapter<Float> adapter = new ArrayAdapter<Float>(getContext(), R.layout.list_helper, employee.getCard().payments);
